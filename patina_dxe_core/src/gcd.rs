...
mod tests {
    ...
    fn test_activate_compatibility_mode_allowed() {
        ...
        with_locked_state(|| {
            ...
            // SAFETY: Test code. `loader_code_mem` is set up above so a valid pointer is passed in.
            unsafe {
            ...
            // SAFETY: Test code. `image_base_page` is set up above so a valid pointer is passed in.
            unsafe {
                allocator::core_allocate_pages(
                    efi::ALLOCATE_ANY_PAGES,
